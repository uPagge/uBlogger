...
var Theme=function(){this.config=window.config;this.data=this.config.data;(this.isDark="dark"===document.body.getAttribute("theme"))?window.REMARK42.changeTheme("dark"):window.REMARK42.changeTheme("light");this.util=new Util;this.oldScrollTop=this.newScrollTop=this.util.getScrollTop();this.scrollEventSet=new Set;this.resizeEventSet=new Set;this.switchThemeEventSet=new Set;this.clickMaskEventSet=new Set;window.objectFitImages&&objectFitImages()};
