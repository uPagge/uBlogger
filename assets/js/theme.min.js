...
Theme.prototype.initSwitchTheme=function(){var a=this;this.util.forEach(document.getElementsByClassName("theme-switch"),function(b){b.addEventListener("click",function(){"dark"===document.body.getAttribute("theme")?document.body.setAttribute("theme","light"):document.body.setAttribute("theme","dark");a.isDark=!a.isDark;window.localStorage&&localStorage.setItem("theme",a.isDark?"dark":"light");for(var c=$jscomp.makeIterator(a.switchThemeEventSet),d=c.next();!d.done;d=c.next())d=d.value,d()},!1)})};
