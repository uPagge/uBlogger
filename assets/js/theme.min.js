...
var Theme=function(){var a=this;this.config=window.config;this.data=this.config.data;this.isDark="dark"===document.body.getAttribute("theme");this.util=new Util;this.oldScrollTop=this.newScrollTop=this.util.getScrollTop();this.scrollEventSet=new Set;this.resizeEventSet=new Set;this.switchThemeEventSet=new Set;this.clickMaskEventSet=new Set;window.objectFitImages&&objectFitImages();document.addEventListener("readystatechange",function(b){"complete"===b.target.readyState&&a.isDark&&window.REMARK42.changeTheme("dark")})};
...
Theme.prototype.initSwitchTheme=function(){var a=this;this.util.forEach(document.getElementsByClassName("theme-switch"),function(b){b.addEventListener("click",function(){"dark"===document.body.getAttribute("theme")?(document.body.setAttribute("theme","light"),window.REMARK42.changeTheme("light")):(document.body.setAttribute("theme","dark"),window.REMARK42.changeTheme("dark"));a.isDark=!a.isDark;window.localStorage&&localStorage.setItem("theme",a.isDark?"dark":"light");for(var c=$jscomp.makeIterator(a.switchThemeEventSet),
...
"flash")}),c.appendChild(e));b.insertBefore(c,b.firstChild)}})};Theme.prototype.initTable=function(){this.util.forEach(document.querySelectorAll(".content table"),function(a){var b=document.createElement("div");b.className="table-wrapper";a.parentElement.replaceChild(b,a);b.appendChild(a)})};
Theme.prototype.initHeaderLink=function(){for(var a=1;6>=a;a++)this.util.forEach(document.querySelectorAll(".single .content > h"+a),function(b){b.classList.add("headerLink");b.insertAdjacentHTML("afterbegin",'<a href="#'+b.id+'" class="header-mark"></a>')})};
...
k(0)})}};
Theme.prototype.initComment=function(){var a=this;if(this.config.comment&&(this.config.comment.remark42&&(this.isDark?window.REMARK42.changeTheme("dark"):window.REMARK42.changeTheme("light")),this.config.comment.gitalk&&(this.config.comment.gitalk.body=decodeURI(window.location.href),(new Gitalk(this.config.comment.gitalk)).render("gitalk")),this.config.comment.valine&&new Valine(this.config.comment.valine),this.config.comment.utterances)){var b=this.config.comment.utterances,c=document.createElement("script");c.src=
"https://utteranc.es/client.js";c.type="text/javascript";c.setAttribute("repo",b.repo);c.setAttribute("issue-term",b.issueTerm);b.label&&c.setAttribute("label",b.label);c.setAttribute("theme",this.isDark?b.darkTheme:b.lightTheme);c.crossOrigin="anonymous";c.async=!0;document.getElementById("utterances").appendChild(c);this._utterancesOnSwitchTheme=this._utterancesOnSwitchTheme||function(){var d={type:"set-theme",theme:a.isDark?b.darkTheme:b.lightTheme};document.querySelector(".utterances-frame").contentWindow.postMessage(d,
"https://utteranc.es")};this.switchThemeEventSet.add(this._utterancesOnSwitchTheme)}};Theme.prototype.initSmoothScroll=function(){SmoothScroll&&new SmoothScroll('[href^="#"]',{speed:300,speedAsDuration:!0,header:"#header-desktop"})};Theme.prototype.initCookieconsent=function(){this.config.cookieconsent&&cookieconsent.initialise(this.config.cookieconsent)};
